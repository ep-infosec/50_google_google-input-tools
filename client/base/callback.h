...
//
// Author: Huican Zhu (original code and idea)
// Author: Sanjay Ghemawat (improvements and simplifications)
//
...
// https://wiki.corp.google.com/twiki/bin/view/Codelab/CallbacksClosures
//
...
#include "base/callback-types.h"  // IWYU pragma: export
...
public:
  ...
  void Reset(Closure *c) {
    delete closure_; closure_ = c;
  }
  Closure* Release() {
    Closure* c = closure_; closure_ = NULL; return c;
  }
  bool empty() const {
